...
export const ProductsPage = () => {
    return (
        <div className="bg-sidebar rounded-2xl mt-4 p-6 max-w-xl mx-auto">
            ...
            <p className="text-sm text-center text-gray-300 w-96 mt-2 mx-auto">Generate maker volume on Dexscreener to help boost your trending score. For only 0.0005 SOL per maker (minimum of 10 makers required)</p>
            <form>
