...
export const TasksPage = () => {
    return (
        <div className="bg-sidebar rounded-2xl p-6 mt-4 max-w-xl mx-auto">
            ...
            <p className="text-sm text-center text-gray-300 md:w-96 mt-2 mx-auto">Fetch a list of token holders for a particular token. Just input the contract address to start.
            ‍</p>
            <form>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
                    <div className=" flex relative flex-col gap-3">
                        <label className="text-sm text-gray-300">Token Address</label>
                        <input type="text" placeholder="Mint Contact Address" className="pr-3 placeholder:font-light placeholder:text-sm rounded-full border-0 focus:border focus:border-white focus:ring-0 focus:outline-none bg-[#151B2D] pl-10 py-2" />
                    ...
                    <div className=" flex relative flex-col gap-3">
                        ...
                        <input type="text" placeholder="Markers required" className="pr-3 placeholder:font-light placeholder:text-sm rounded-full border-0 focus:border focus:border-white focus:ring-0 focus:outline-none bg-[#151B2D] pl-10 py-2" />
                        <IconExclamationCircle className="absolute h-4 w-4 left-4 top-11" />
                    </div>
                    <div className=" flex relative flex-col gap-3">
                        <label className="text-sm text-gray-300">Offset</label>
                        <input type="text" placeholder="Offset Amount" className="pr-3 placeholder:font-light placeholder:text-sm rounded-full border-0 focus:border focus:border-white focus:ring-0 focus:outline-none bg-[#151B2D] pl-10 py-2" />
                        <IconExclamationCircle className="absolute h-4 w-4 left-4 top-11" />
                    </div>
                </div>
